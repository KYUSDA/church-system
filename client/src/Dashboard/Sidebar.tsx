...
export function AppSidebar({ userRole, ...props }: AppSidebarProps) {
  ...
  return (
    <Sidebar
      className="bg-white border border-r-gray-200 text-gray-900 "
      collapsible="offcanvas"
      {...props}
    >
      <SidebarHeader className="bg-white text-gray-900">
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton
              asChild
      ...
      <SidebarContent className="overflow-hidden hover:overflow-y-auto sidebar-scroll bg-white text-gray-900 ">
