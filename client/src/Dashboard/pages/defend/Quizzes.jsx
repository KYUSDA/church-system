...
function Quizzes({ quiz, onBack }) {
  ...
  // Handle window resizing for confetti effect
  useEffect(() => {
  ...
  const calculateScore = async () => {
    ...
    await sendResults(correctCount, correctAnswers, userAnswers);
  };

  const sendResults = async (correctAnswers, userAnswers) => {
    try {
        const userData = JSON.parse(localStorage.getItem("user"));
        const token = userData?.tk; // Extract token
