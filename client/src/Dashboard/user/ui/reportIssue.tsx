      ...
      <div className="bg-gray-100 p-4 rounded-lg mb-6">
        ...
        <ul className="space-y-3">
          <li className="flex items-center space-x-2">
            ...
            <span>
              <strong>Bugs & Errors:</strong> Any technical issues, crashes, or
              unexpected behavior.
            </span>
          </li>
          <li className="flex items-center space-x-2">
            ...
            <span>
              <strong>Functionality Issues:</strong> Features not working as
              expected or missing functionalities.
            </span>
          </li>
          <li className="flex items-center space-x-2">
            <MdDesignServices className="text-green-500 text-xl" />
            <span>
              <strong>UI/UX Suggestions:</strong> Design improvements,
              readability, or user experience enhancements.
            </span>
          </li>
        </ul>
      </div>
