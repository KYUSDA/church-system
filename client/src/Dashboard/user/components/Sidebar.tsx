      ...
      <nav className="relative transition-all duration-300 ease-in-out">
        ...
        <div className="p-4 flex flex-col justify-between h-[calc(100%-5rem)]">
          <div className="flex items-center space-x-4 mb-6">
            ...
            />
            <div>
              <h3 className="font-semibold truncate overflow-hidden whitespace-nowrap max-w-[10rem]">
                {fullname}
              </h3>
            </div>
          </div>
            ...
            <li className="flex flex-col gap-y-4">
              {navItems.map((item) => (
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `flex items-center space-x-3 p-3 rounded-lg relative group ${
