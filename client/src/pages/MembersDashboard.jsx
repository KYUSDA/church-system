...
const MembersDashboard = () => {
	...
	return (
		<div className="flex h-screen bg-gray-50">
			<nav className="w-64 bg-white shadow-lg relative">
				...
				<div className="p-4 flex flex-col justify-between">
					...
					<ul className="space-y-2">
						<li className="flex flex-col gap-y-4">
							<NavLink
								to="/member"
								className={({ isActive }) =>
									`flex items-center space-x-3 p-3 rounded-lg ${isActive ? 'bg-blue-50 text-blue-600' : 'hover:bg-blue-50'
									}`
								}
							>
							...
							>
								<svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
									<path d="M4 4v18h16V4H4zm14 16H6V6h12v14zm-3-7H9v-2h6v2zm0-4H9V7h6v2zm-6 8h6v-2H9v2z" />
								</svg>
								<span>Resources</span>
							</NavLink>
							...
							>
								<svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
									<path d="M19 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h13c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2m0 18H6V4h13v16m-7-9c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2m4 3c0-1.3-2.7-2-4-2s-4 .7-4 2v1h8v-1m-3.5 4h-1v-1h1v1m-1-2v-1h1v1h-1z" />
								</svg>
								<span>Lesson Discussion</span>
							</NavLink>

							<NavLink
								to="/member/bibleTrivia"
								className={({ isActive }) =>
									`flex items-center space-x-3 p-3 rounded-lg ${isActive ? 'bg-blue-50 text-blue-600' : 'hover:bg-blue-50'
									}`
								}
							>
								<svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
									<path d="M5.81 2H17c1.1 0 2 .9 2 2v16c0 1.1-.9 2-2 2H7c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2m0 2v16h11.17L17 19.83V4H5.81M7 6h9v2H7V6m0 4h9v2H7v-2m0 4h5v2H7v-2z" />
								</svg>
							...
							>
								<svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
									<path d="M12 5.5A3.5 3.5 0 0 1 15.5 9a3.5 3.5 0 0 1-3.5 3.5A3.5 3.5 0 0 1 8.5 9 3.5 3.5 0 0 1 12 5.5M5 8c.56 0 1.08.15 1.53.42-.15 1.43.27 2.85 1.13 3.96C7.16 13.34 6.16 14 5 14a3 3 0 0 1-3-3 3 3 0 0 1 3-3m14 0a3 3 0 0 1 3 3 3 3 0 0 1-3 3c-1.16 0-2.16-.66-2.66-1.62.86-1.11 1.28-2.53 1.13-3.96C17.92 8.15 18.44 8 19 8M5.5 18.25c0-2.07 2.91-3.75 6.5-3.75s6.5 1.68 6.5 3.75V20h-13v-1.75M0 20v-1.5c0-1.39 1.89-2.56 4.45-2.9-.59.68-.95 1.62-.95 2.65V20H0m24 0h-3.5v-1.75c0-1.03-.36-1.97-.95-2.65 2.56.34 4.45 1.51 4.45 2.9V20z" />
								</svg>
								<span>Family</span>
							</NavLink>
					...
					<button
						className="flex items-center space-x-3 p-3 mt-4 w-full rounded-lg hover:bg-red-50 hover:text-red-600 transition-colors  absolute bottom-0"
					>
						<svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
