...
const DepartmentsDetails = () => {
  ...
  const department = useSelector((state: { departments: { departments: Department[] } }) => state.departments.departments)?.find((dept) => dept?._id === departmentId);

  return (
    <div className="min-h-screen bg-gray-100 py-12">
      {/* Breadcrumbs */}
      {department && <Breadcrumbs department={department} />}
