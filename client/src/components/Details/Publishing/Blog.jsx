...
import egw from '../../../assets/EGW.jpg'
const sections = [
  { title: 'Home', url: '/' },
  { title: 'About Us', url: '/' },
  { title: 'Families', url: '/' },
...
const mainFeaturedPost = {
  title: 'Welcome to Publishing Department',
  description:
...
const featuredPosts = [
  {
    title: 'About Us ',
    description:
      'This department comprise of library department,In the library, we have different collections, such as printed information materials (books), audio visual, CDs and DVDs which help people grow spiritually.'
  },
  {
    title: 'Members',
    description:
      'The department head is Shadrack Otieno'
  },
];
