...
import { TFamily, useGetFamiliesQuery } from "../../services/userServices";
...
const AFamily: React.FC = () => {
  ...
  const handleClick = async (e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    try {
      const response = await fetch(`${BASE_URL}/family/update-family/${family._id}`, {
        method: "PATCH",
        headers: {
    ...
    <div className="flex flex-col items-center p-6">
      ...
      <div className="w-full max-w-3xl bg-white shadow-lg rounded-xl p-6">
        ...
        />
          ...
          <p className="text-gray-500 mt-2">{family?.description || "No description"}</p>
        </div>
